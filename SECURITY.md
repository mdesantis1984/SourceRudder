...
Use GitHub's [private vulnerability reporting form](https://github.com/mdesantis1984/SourceRudder/security/advisories/new).
If the form is unavailable, contact a maintainer through a trusted private
channel to establish a secure exchange. Do not include exploit details in a
public issue, discussion, pull request, or other shared channel.
